...
predict_parser.add_argument('input', action="store", nargs='*', default='/home/workspace/ImageClassifier/flowers/test/1/image_06752.jpg')
    # Non-optional checkpoint 
predict_parser.add_argument('checkpoint', action="store", nargs='*', default='/home/workspace/ImageClassifier/checkpoint.pth')
    # Choose top K 
